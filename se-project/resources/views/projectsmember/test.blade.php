...
<body>
    ...
    <div class="container-fluid p-4">
        <div class="bg" style="height:840px; background: #92C7CF; border-radius: 20px; overflow: hidden;">
            <div class="manage p-1" style="height:70px; text-align: center; font-size: 36px; ">
                ...
                <div class="detail-fluid" style=" height:710px; overflow: auto;">
                    ...
                    @foreach ($projectId as $item)
                        <div class="Submit px-4 pb-2">
                            <a href="{{ route('manage', ['projectId' => $item->id]) }}" class="btn custom-button"
                                style="background-color: #FBF9F1; border: 1px solid #E5E1DA;">{{ $item->id }}</a>
                        </div>
                    @endforeach
                </div>
